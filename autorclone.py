...
cmd_rclone = 'rclone move /disk3/video GDrive:/ --multi-thread-streams 10 --ignore-existing --bwlimit 950M --drive-chunk-size 1024M --drive-server-side-across-configs -vv --include "/*.plot" -P'
